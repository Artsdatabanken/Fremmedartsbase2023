            ...
            <div className="_container">
               ...
               <ul className="nav_menu">
                    ...
                    {(auth.isInRole("fab_administrator") && appState.viewMode === "assessment") ? 
                     <li onClick={action(() => {if (auth.isLoggedIn && !appState.isDirty) { appState.viewMode = "moveassessment" }})} disabled={(!auth.isLoggedIn || appState.isDirty)}><b>Flytt vurdering</b></li> : null}
