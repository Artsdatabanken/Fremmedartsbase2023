               ...
               <ul className="nav_menu">
                    ...
                    <li role="presentation">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a className="dropdown-item" target="_blank" href="https://www.artsdatabanken.no/Files/42287/Retningslinjer_for__kologisk_risikovurdering_av_fremmede_arter._Versjon_4.3">{labels.guidelines}</a></li>
                            <li><a className="dropdown-item" target="_blank" href="https://www.artsdatabanken.no/Files/42306/Brukermanual_for_FremmedArtsBasen_2023._Horisontskanning_og__kologisk_risikovurdering_av_fremmede_arter.">{labels.userManual}</a></li>
