                        ...
                        <table className="table table-striped comments">
                            ...
                            {this.comments &&
                                ...
                                <tr key={item.id}>
                                    ...
                                    { (rolle.admin || rolle.skriver) && <button className="btn btn-primary btn-xs" disabled={item.closed}  onClick={() => {this.closeComment(item.id, appState)}}>{labels.processed}</button> }                                                                       
                                </td> : <td>                                    
                                </td>}
                                </tr>                             
                            )})}
