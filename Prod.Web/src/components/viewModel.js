        ...
        extendObservable(this, {
            assessmentTabs: {
                ...
                tabList: [
                    ...
                    new tabItem({id: 7, label:"Inovasjonspotensiale 51", enabled: this.harVurdering, notrequired: !this.skalVurderes, url: "inovasjonspotensiale" }),
                    ...
                    new tabItem({id: 12, label:"Referanser", enabled:this.harVurdering, url: "referanser"}),
                    // new tabItem({id: 11, label:"Kommentarer", enabled:this.harVurdering, url: "Kommentarer"}),
                    new tabItem({id: 13, label:"JSON", enabled:this.harVurdering, url: "diff"})
