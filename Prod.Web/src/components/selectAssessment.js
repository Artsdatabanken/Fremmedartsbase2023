                ...
                <div className="nav_menu">
                        <div className="filters"><b>{labels.SelectAssessment.assessmentStatus}</b>   
                            ...
                            <div className="subChoice">
                                    <Xcomp.Bool observableValue={[appState.horizonScanFilter, "toAssessment"]} label={" (" + appState.getStatisticsFor(appState.assessmentsStatistics,'Progress','1') + ") " + (appState.getStatisticsFor(appState.assessmentsStatistics,'Progress','1,0').toFixed() > 0 ? (100*appState.getStatisticsFor(appState.assessmentsStatistics,'Progress','1,0')/appState.getStatisticsFor(appState.expertgroupAssessmentTotalCount)) : "0") + labels.SelectAssessment.further} />
