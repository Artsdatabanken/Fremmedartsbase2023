        ...
        { 
            var mapperConfig = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<FA3Legacy.ImpactedNatureType, FA4.ImpactedNatureType>()
                    .ForMember(dest => dest.MajorTypeGroup, opt => opt.Ignore())
                    .ForMember(dest => dest.Background, opt => opt.Ignore())
                    .ForMember(dest => dest.Name, opt => opt.Ignore())
                ...
                cfg.CreateMap<FA3Legacy, FA4>()
                    ...
                    .ForMember(dest => dest.MisIdentified, opt => opt.Ignore())
                    .ForMember(dest => dest.MisIdentifiedDescription, opt => opt.Ignore())
                    .ForMember(dest => dest.AllSubTaxaAssessedSeparately, opt => opt.Ignore())
                    .ForMember(dest => dest.AllSubTaxaAssessedSeparatelyDescription, opt => opt.Ignore())
                    .ForMember(dest => dest.IsHybridWithoutOwnRiskAssessment, opt => opt.Ignore())
                    .ForMember(dest => dest.IsHybridWithoutOwnRiskAssessmentDescription, opt => opt.Ignore())
                    ...
                    .ForMember(dest => dest.ArtskartExcludedLocalities, opt => opt.Ignore()) // ny av året
                    ...
                    .ForMember(dest => dest.ConnectedTaxons, opt => opt.Ignore()) //Ny 
