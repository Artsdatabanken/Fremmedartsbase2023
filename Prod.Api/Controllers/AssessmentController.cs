...
//        {
//            var fylker =
//            new Dictionary<string, FA3.Fylkesforekomst>()
//            {
//                {"Trøndelag", new FA3.Fylkesforekomst() {Fylke = "Tø", State = 2}},
//                {"Nordland", new FA3.Fylkesforekomst() {Fylke = "No", State = 2}},
//                {"Finnmark", new FA3.Fylkesforekomst() {Fylke = "Fi", State = 2}},
//                {"Troms", new FA3.Fylkesforekomst() {Fylke = "Tr", State = 2}},
//                {"Hedmark", new FA3.Fylkesforekomst() {Fylke = "He", State = 2}},
//                {"Oppland", new FA3.Fylkesforekomst() {Fylke = "Op", State = 2}},
//                {"Møre og Romsdal", new FA3.Fylkesforekomst() {Fylke = "Mr", State = 2}},
//                {"Sogn og Fjordane", new FA3.Fylkesforekomst() {Fylke = "Sf", State = 2}},
//                {"Hordaland", new FA3.Fylkesforekomst() {Fylke = "Ho", State = 2}},
//                {"Buskerud", new FA3.Fylkesforekomst() {Fylke = "Bu", State = 2}},
//                {"Oslo og Akershus", new FA3.Fylkesforekomst() {Fylke = "OsA", State = 2}},
//                {"Østfold", new FA3.Fylkesforekomst() {Fylke = "Øs", State = 2}},
//                {"Vestfold", new FA3.Fylkesforekomst() {Fylke = "Ve", State = 2}},
//                {"Telemark", new FA3.Fylkesforekomst() {Fylke = "Te", State = 2}},
//                {"Aust-Agder", new FA3.Fylkesforekomst() {Fylke = "Aa", State = 2}},
//                {"Vest-Agder", new FA3.Fylkesforekomst() {Fylke = "Va", State = 2}},
//                {"Rogaland", new FA3.Fylkesforekomst() {Fylke = "Ro", State = 2}},
//                {"Nordsjøen", new FA3.Fylkesforekomst() {Fylke = "Ns", State = 2}},
//                {"Norskehavet", new FA3.Fylkesforekomst() {Fylke = "Nh", State = 2}},
//                {"asdfs", new FA3.Fylkesforekomst() {Fylke = "Gh", State = 2}},
//                {"Polhavet", new FA3.Fylkesforekomst() {Fylke = "Bn", State = 2}},
//                {"Barentshavet", new FA3.Fylkesforekomst() {Fylke = "Bs", State = 2}}
//            };

//            assessment.Fylkesforekomster = new List<FA3.Fylkesforekomst>();
//            foreach (var fylkesforekomst in fylker)
//            {
//                var valueFylke = fylkesforekomst.Value.Fylke;
//                assessment.Fylkesforekomster.Add(new FA3.Fylkesforekomst()
//                { Fylke = valueFylke, State = 2 });
//            }
//        }

//        private static void SetArtskartImportSettings(FA3 assessment)
//        {
